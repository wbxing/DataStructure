...
var treeMenu = [
	{ level:1, name:"学生管理"},
	{ level:2, name:"查询学生", ico:"images/icon_default.gif",link:"students/Students_query.action"},
    { level:2, name:"添加学生", ico:"images/icon_default.gif",link:"<%=path%>/students/Students_add.jsp"}
	// { level:1, name:"教师管理"},
